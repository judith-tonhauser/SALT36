...
To run a model directly, `webppl model.wppl` after uncommenting one of the calls at the bottom of the file; `model-evaluation.R` is run from within its folder.
